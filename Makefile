...
coverage: ## check code coverage quickly with the default Python
	coverage run --source service_token_authenticator runtests.py tests
	coverage report -m
	coverage html
	open htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/drf-service-token-authenticator.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ service_token_authenticator
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
